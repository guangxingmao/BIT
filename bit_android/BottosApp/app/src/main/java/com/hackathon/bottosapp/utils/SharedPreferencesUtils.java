package com.hackathon.bottosapp.utils;
...
public class SharedPreferencesUtils {
    ...
    public static final String PREF_NAME           = "bottos_android_pref";
    public static final String BOTTOS_ACCOUNT_INFO = "bottos_account_info";
