...
import com.hackathon.bottosapp.bottos_sdk.Config.Config;
import com.hackathon.bottosapp.bottos_sdk.log.BtoLog;
import com.hackathon.bottosapp.bottos_sdk.net.interceptor.HttpRequestInterceptor;
import com.hackathon.bottosapp.bottos_sdk.net.response.CommonResponse;
import com.hackathon.bottosapp.bottos_sdk.utils.GJsonUtil;
        ...
        return new Subscriber<T>() {
            ...
            public void onError(Throwable e) {
                if (e instanceof NetRequestException) {
                    ...
                    BtoLog.e("BtoLog", exception.getMessage());
                } else {
